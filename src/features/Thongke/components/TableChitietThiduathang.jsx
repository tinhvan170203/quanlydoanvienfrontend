          ...
          {(rowsPerPage > 0
              ...
              : list
                ...
                <TableCell
                  ...
                  align="left"
                >
                  {row.blue} lượt <span className="font-bold">({row.thoigians_blue.length > 0 && row.thoigians_blue.map(i=>dayjs(i).format('DD/MM/YYYY').slice(3)).toString()})</span>
                </TableCell>
                <TableCell
                  className="border-r border-slate-300"
                  align="left"
                >
                  {row.yellow} lượt <span className="font-bold">({row.thoigians_yellow.length > 0 && row.thoigians_yellow.map(i=>dayjs(i).format('DD/MM/YYYY').slice(3)).toString()})</span>
                </TableCell>
                <TableCell
                  className="border-r border-slate-300"
                  align="right"
