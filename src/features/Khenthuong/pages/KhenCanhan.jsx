  ...
  return (
    <div className='pr-2' data-aos="fade-left" data-aos-once="true">
      <div className='flex items-center space-x-1'>
        ...
        <h4 className='font-bold text-gray-800 text-lg'>Quản lý khen thưởng đối với cá nhân
          {canbo &&
      ...
      {canbo && (
        <>
          ...
          {roles && roles.includes('thêm khen thưởng, kỉ luật') && (
            <Button type='submit' sx={{ width: "350px", backgroundColor: "gray" }} onClick={() => handleOpenDialogAdd()} color="primary" variant='contained'><AddIcon /> Thêm mới khen thưởng</Button>
          )}
      ...
      {canbo && (
        <div className='mt-6 mx-8' data-aos="zoom-in-up" data-aos-once="true">
          <h3 className='text-center my-4 text-xl'>Danh sách kết quả khen thưởng đối với cá nhân</h3>
          <TableKhencanhan
            list={khenthuongs}
