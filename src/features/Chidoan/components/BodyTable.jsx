  ...
  return (
    <TableRow key={row._id} className="hover:bg-slate-200 transition duration-300">
      ...
      <TableCell
        ...
        align="left"
      >
        {row.nhomdonvithuocchidoan.map(i=><span key={i._id}>{i.tendonvi} ,</span>)}
      </TableCell>
      <TableCell
        className="border-r border-slate-300"
        align="left"
      ...
      <TableCell
        ...
        align="left"
      >
        {row.status === true ? <Button color="success">Active</Button> : <Button color="warning">NonActive</Button>}
      </TableCell>
